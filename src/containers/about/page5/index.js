                    ...
                    <ol>
                        <li>
                            <Row gutter={20}>
                                ...
                                <Col md={18}>
                                    <p><Link to="/about/news1" target="_blank">华赢宝累计成交突破10亿元</Link></p>
                                    <p>2017年11月10日</p>
                        ...
                        <li>
                            <Row gutter={20}>
                                ...
                                <Col md={18}>
                                    <p><Link to="/about/news2" target="_blank">「华赢宝征文活动」有华赢宝的日子，树桩吐绿，鸟语花香</Link></p>
                                    <p>2017年11月08日</p>
                        ...
                        <li>
                            <Row gutter={20}>
                                ...
                                <Col md={18}>
                                    <p><Link to="/about/news3" target="_blank">华赢宝获批ICP证，积极响应监管政策变化</Link></p>
                                    <p>2017年10月27日</p>
                        ...
                        <li>
                            <Row gutter={20}>
                                ...
                                <Col md={18}>
                                    <p><Link to="/about/news4" target="_blank">华赢宝赞助2017萧山广场舞大赛完美结束</Link></p>
                                    <p>2017年08月30日</p>
                        ...
                        <li>
                            <Row gutter={20}>
                                ...
                                <Col md={18}>
                                    <p><Link to="/about/news5" target="_blank">华赢宝携手三家优质资产对接，加速合规建设</Link></p>
                                    <p>2017年08月07日</p>
                        ...
                        <li>
                            <Row gutter={20}>
                                ...
                                <Col md={18}>
                                    <p><Link to="/about/news6" target="_blank">支氏控股集团华赢宝发布验资报告</Link></p>
                                    <p>2017年07月07日</p>
